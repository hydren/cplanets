...
/**
 * This {@link AWTEventListener} tries to work around <a href="http://bugs.sun.com/view_bug.do?bug_id=4153069">a 12 years old
 * bug</a> in the Linux KeyEvent handling for keyboard repeat. Linux apparently implements repeating key presses by
...
public class RepeatingReleasedEventsFixer implements AWTEventListener {
    ...
    private static RepeatingReleasedEventsFixer _instance;
    
    public static void install() {
    	if(_instance == null){
    		_instance = new RepeatingReleasedEventsFixer();
    		Toolkit.getDefaultToolkit().addAWTEventListener(_instance, AWTEvent.KEY_EVENT_MASK);
    	}
    }
    ...
    public static void uninstall() {
    	if(_instance != null){
    		_instance = null;
    		Toolkit.getDefaultToolkit().removeAWTEventListener(_instance);
    	}
    }
