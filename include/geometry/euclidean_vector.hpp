...
struct EuclideanVector
{
		...
		long getNumberOfDimensions() abstract;
		...
		EuclideanVector& getCanonicalBasis();
		...
		EuclideanVector& sum(EuclideanVector& v);
		...
		EuclideanVector& add(EuclideanVector& v);
		...
		EuclideanVector& difference(EuclideanVector& v);
		...
		EuclideanVector& subtract(EuclideanVector& v);
		...
		EuclideanVector& times(double factor);
		...
		double distance(EuclideanVector& v);
		...
		double innerProduct(EuclideanVector& v);
		...
		EuclideanVector& vectorProduct(EuclideanVector* vectors);
};
