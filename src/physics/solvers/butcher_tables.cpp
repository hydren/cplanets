...
const double RK4_RALSTON[5][5] = {
		{0,						X,							X,							X,										X},
		{0.4, 					0.4,						X,							X,										X},
		{0.875-0.1875*s5,		(-2889.0+1428.0*s5)/1024.0,	(3785.0-1620.0*s5)/1024.0,	X,										X},
		{1,						(-3365.0+2094.0*s5)/6040.0,	(-975.0-3046.0*s5)/2552.0,	(467040.0+203968.0*s5)/240845.0,		X},
		{X,						(263.0+24.0*s5)/1812.0,		(125.0-1000.0*s5)/3828.0,	(3426304.0+1661952.0*s5)/5924787.0,		(30.0-4.0*s5)/123.0}
};
