...
const double RK4_GILL[5][5] = {
		...
		{1,			-s2*0.5,		1+s2*0.5,		1,				X},
		{X,			1.0/6.0,		(2-s2)/6.0,		(2+s2)/6.0, 	1}
};
...
const double RK4_RALSTON[5][5] = {
		{0,						X,						X,						X,									X},
		{0.4, 					0.4,					X,						X,									X},
		{7.0/8.0-3.0*s5/16.0,	(-2889+1428*s5)/1024.0,	(3785-1620*s5)/1024.0,	X,									X},
		{1,						(-3365+2094*s5)/6040.0,	(-975-3046*s5)/2552.0,	(467040+203968*s5)/2400845.0,		X},
		{X,						(263 + 24*s5)/1812.0,	(125-1000*s5)/3828.0,	1024*(3346 + 1623*s5)/5924787.0, 	(30 - 4*s5)/123.0}
};
