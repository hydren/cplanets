...
GenericListWin::GenericListWin(WinBase *parent, Style, Rect rect, Id id)
...
void GenericListWin::onMouseDown(Point point, int buttonNumber)
{
...
void GenericListWin::onMouseMove(Point point, int buttonNumber) {}  // by default does nothing

void GenericListWin::onMouseUp(Point point, int buttonNumber) {}  // by default does nothing


// ################# static functions to be used when referencing ListWin's as a BgrWin's.  #################
void GenericListWin::drawBgrWinAsListWin(BgrWin* listWinAsBgrWin) 				{ static_cast<GenericListWin*>(listWinAsBgrWin)->draw(); }
void GenericListWin::onMouseDown(BgrWin* listWinAsBgrWin,int x,int y,int but) 	{ static_cast<GenericListWin*>(listWinAsBgrWin)->onMouseDown(Point(x, y), but); }
void GenericListWin::onMouseMove(BgrWin* listWinAsBgrWin,int x,int y,int but) 	{ static_cast<GenericListWin*>(listWinAsBgrWin)->onMouseMove(Point(x, y), but); }
void GenericListWin::onMouseUp(BgrWin* listWinAsBgrWin,int x,int y,int but) 	{ static_cast<GenericListWin*>(listWinAsBgrWin)->onMouseUp(Point(x, y), but); }
