...
SDL_util::Color5::Color5(Uint32 fst, Uint32 lst)
: ready(false)
{
	this->c[0] = fst;
	this->c[4] = lst;
...
void SDL_util::Color5::set_col(Uint32 fst,Uint32 lst) { // fst, lst e.g.: 0x102030ff, output c[i] e.g: 0x102030
  for (int i=0;i<5;++i) {
    Uint32 cc=0;
...
void SDL_util::Color5::draw_gradient(WinBase* self, Rect rect, bool vertical, bool hollow) const
{
...
void SDL_util::Color5::setup()
{
	if(not ready)
		this->set_col(this->c[0], this->c[4]);
}

const SDL_util::Color5
	SDL_util::Color5::GradientBlue(0xf0ffffff, 0xa0d0e0ff),
	SDL_util::Color5::GradientDarkBlue(0xa0f0ffff, 0x3094d0ff),
	SDL_util::Color5::GradientWheat(0xfff0d7ff, 0xc0c0a0ff),
	SDL_util::Color5::GradientGrey(0xffffffff, 0xc7c7c7ff),
	SDL_util::Color5::GradientDarkGrey(0xf0f0f0ff, 0x707070ff),
	SDL_util::Color5::GradientGreen(0xe0ffe0ff, 0x77c077ff),
	SDL_util::Color5::GradientRose(0xffd0d0ff, 0xd07070ff);
